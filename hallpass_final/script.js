...
function saveSettings() {
	...
	// save students out max
	allowedOut = document.getElementById("settingOutMax").value;
	localStorage.setItem("allowedOut", allowedOut);
	// save teacher name
	teacherName = document.getElementById("settingTeacher").value;
	localStorage.setItem("teacherName", teacherName);
	// save class name
	className = document.getElementById("settingClass").value;
...
function getSettings() {
	if (typeof(Storage) !== "undefined") {
		...
		if (tempOut == null) {
			localStorage.setItem("allowedOut", "2");
		}
		else {
			allowedOut = tempOut;
		}
		...
		if (tempTeacher == null) {
			localStorage.setItem("teacherName", "Mr. Smith");
		}
		else {
		...
		if (tempClass == null) {
			localStorage.setItem("className", "6th Science");
		}
		else {
			className = tempClass;
		}
