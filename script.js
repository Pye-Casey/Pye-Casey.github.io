...
function signIn() {
	...
	// reset return by
	console.log("Calling Element: " + callingElement);
	var returnDiv = document.getElementById("return_" + callingElement);
	returnDiv.classList.remove("return");
	returnDiv.classList.add("returnBlank");
	var stReturnTime = "returnTime_" + callingElement;	
	var returnTime = document.getElementById(stReturnTime);
	returnTime.innerHTML = "00:00";
...
function assignCard(student) {
	...
	var returnDiv = document.getElementById("return_" + callingElement);
	console.log("Calling element: " + callingElement );
	console.log("Element name: " + returnDiv.id);
	console.log("Classes: " + returnDiv.classList);
	returnDiv.classList.remove("returnBlank");
	...
	if (newM > 59) {
		...
		alteredM = newM - 60;
		// display return time
		returnTime.innerHTML = newH + ":" + alteredM;
	} else {
		if (newM > 9) {
			returnTime.innerHTML = h + ":" + newM.toFixed(0);
		} else {
			returnTime.innerHTML = h + ":0" + newM.toFixed(0);
		}
